...
GRANT SELECT, INSERT, UPDATE, DELETE ON proveedoresCABA TO role_compras_caba;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON proveedoresInterior TO role_compras_interior;
