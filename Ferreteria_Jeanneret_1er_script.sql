...
-- select *
-- from ferreteria3Hermanos.proveedores;
...
CREATE TABLE IF NOT EXISTS producto_unico(
  PRO_UNI INT NOT NULL UNIQUE AUTO_INCREMENT
, PRO_PRO INT NOT NULL 
, LIS_EMP INT NOT NULL 
);
...
ALTER TABLE producto_por_proveedor ADD CONSTRAINT 
FK_productoPorPro_decripcionPro FOREIGN KEY FK_productoPorPro_decripcionPro(COD_PRO)
REFERENCES descripcion_productos (COD_PRO);

ALTER TABLE producto_unico ADD CONSTRAINT FK_ProUni_listas FOREIGN KEY FK_ProUni_listas(LIS_EMP)
REFERENCES listas_proveedores (LIS_EMP),
ADD CONSTRAINT FK_ProUni_ProPorPro FOREIGN KEY FK_ProUni_ProPorPro(PRO_PRO)
REFERENCES producto_por_proveedor (PRO_PRO),
ADD CONSTRAINT PK_PRO_STO PRIMARY KEY (PRO_PRO, LIS_EMP); -- CONCATENADA
...
ADD CONSTRAINT FK_detalleCpa_productoUnico FOREIGN KEY FK_detalleCpa_productoUnico(PRO_UNI)
REFERENCES producto_unico (PRO_UNI),
ADD CONSTRAINT PK_PRO_CPA PRIMARY KEY (PRO_UNI, CAN_PRO); -- CONCATENADA;
...
ADD CONSTRAINT FK_detalleVta_productoUnico FOREIGN KEY FK_detalleVta_productoUnico(PRO_UNI)
REFERENCES producto_unico (PRO_UNI),
ADD CONSTRAINT PK_PRO_VTA PRIMARY KEY (PRO_UNI, CAN_PRO); -- CONCATENADA;


ALTER TABLE stock ADD CONSTRAINT FK_stock_productoUnico FOREIGN KEY FK_stock_productoUnico(PRO_UNI)
REFERENCES producto_unico (PRO_UNI),
ADD CONSTRAINT PK_PRO_STO PRIMARY KEY (PRO_UNI, CAN_PRO); -- CONCATENADA

-- select *
-- from ferreteria3Hermanos.detalle_compra;
