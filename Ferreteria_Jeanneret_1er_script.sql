...
TIEMPO DATETIME,
CONSTRAINT PK_PRO_CPA PRIMARY KEY (PRO_CPA)
);
...
CAN_PRO INT NOT NULL,
TIEMPO DATETIME,
CONSTRAINT PK_PRO_VTA PRIMARY KEY (PRO_VTA)
);

CREATE TABLE IF NOT EXISTS stock(
PRO_STO INT NOT NULL UNIQUE,
VAL_UNI DOUBLE NOT NULL UNIQUE,
CAN_PRO INT NOT NULL,
TIEMPO DATETIME,
CONSTRAINT PK_PRO_STO PRIMARY KEY (PRO_STO)
);
